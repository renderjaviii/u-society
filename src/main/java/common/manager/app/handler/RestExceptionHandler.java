...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
        ...
        return new ResponseEntity<>(new ErrorApi(errorMessage, BAD_REQUEST), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<Object> genericExceptionHandler(GenericException ex) {
        return new ResponseEntity<>(new ErrorApi(ex.getMessage(), ex.getErrorCode()), HttpStatus.NOT_ACCEPTABLE);
    }
    ...
    public ResponseEntity<Object> handleConstraintViolationException(HttpServletRequest req,
        ...
        return new ResponseEntity<>(new ErrorApi(errorMessage, "SQL EXCEPTION"), HttpStatus.CONFLICT);
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<Object> exceptionHandler(Exception ex) {

        return new ResponseEntity<>(new ErrorApi(ex.getMessage(), "INTERNAL_SERVER_ERROR"), INTERNAL_SERVER_ERROR);
    }
